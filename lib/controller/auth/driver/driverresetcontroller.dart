...
import 'package:mechanice/data/datasource/remote/auth/driver/resetpass.dart';

abstract class DResetController extends GetxController {
  goToSuccessReset();
}

class DResetControllerImp extends DResetController {
  DResetPassData resetPassData = DResetPassData(Get.find());
    ...
    if (formstate.currentState!.validate()) {
      ...
      if (StatusRequest.success == statusRequest) {
        if (response['status'] == "success") {
          ...
          Get.offNamed("dsuccess", arguments: {"email": email});
        } else {
