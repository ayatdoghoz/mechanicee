...
import 'package:mechanice/controller/auth/mechanicee/regestercontroller.dart';
...
class RegesterPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.put(RegesterControllerImp());
    return Scaffold(
        body: GetBuilder<RegesterControllerImp>(
