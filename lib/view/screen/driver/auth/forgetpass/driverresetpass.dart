...
import 'package:mechanice/controller/auth/driver/driverresetcontroller.dart';
...
class DReSetPass extends StatelessWidget {
  const DReSetPass({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(DResetControllerImp());
    return Scaffold(
        body: GetBuilder<DResetControllerImp>(
